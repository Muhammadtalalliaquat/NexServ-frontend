...
export const ApiRoutes = {
  ...
  getAllBlog: BASIC_URL + `blogs/fetchAllBlogs`,
  ...
  getProject: BASIC_URL + `project/fetchProjects`,
  addProject: BASIC_URL + `project/startProject`,
  updateProjectStatus: BASIC_URL + `project/updateProject`,
