...
export default function HomeRoute({ initialServiceData, initialBlogData, initialReviewData }) {
...
//   }, [dispatch]);
  ...
  return (
    <>
      ...
      />
      <HereSection reviewData={initialReviewData} />
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          {initialServiceData.length > 0 ? (
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {initialServiceData.map((service, idx) => (
                <div
                  key={idx}
        ...
        {initialBlogData.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            <div className="md:col-span-2 md:row-span-2 relative rounded-md overflow-hidden shadow-lg group">
              <Image
                src={
                  initialBlogData[0]?.image ||
                  "https://via.placeholder.com/600x400"
                }
                alt={initialBlogData[0]?.title}
                width={1500}
                height={1500}
              ...
              >
                <h3 className="text-lg font-semibold">
                  {initialBlogData[0]?.title}
                </h3>

                <p className="text-gray-200 text-sm mb-4 line-clamp-2">
                  {initialBlogData[0]?.content}
                </p>

                <Link
                  href={`/blog-page/${initialBlogData[0]._id}`}
                  // href={`/blog-detail/${initialBlogData[0]._id}`}
            ...
            {initialBlogData.slice(1, 3).map((blog, i) => (
              <div
                key={i}
      ...
      <UserFeedBack reviewData={initialReviewData} />
